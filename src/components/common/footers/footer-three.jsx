                            ...
                            <div className="col-lg-3">
                                ...
                                <div className="footer-contant">
                                    <ul className="contact-details">
                                        <li>PP & City  Store, Demo store USA 345-659</li>
                            ...
                            <div className="col p-set">
                                <div className="footer-link">
                                    ...
                                    <div className="footer-contant">
                                        <ul>
                                            <li><Link
                                                to={`${process.env.PUBLIC_URL}/left-sidebar/collection`}>women"s</Link>
                                            </li>
                                            <li><Link
                    ...
                    <div className="row">
                        <div className="col-xl-6 col-md-6 col-sm-12">
                            <div className="footer-end">
                                <p><i className="fa fa-copyright" aria-hidden="true"></i> 2020 powered by
                                    TSD</p>
                            </div>
                        </div>
                        <div className="col-xl-6 col-md-6 col-sm-12">
