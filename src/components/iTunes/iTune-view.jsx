...
class ITuneView extends Component {
  state = {
    open: false,
    nav1: null,
    nav2: null,
    colorID: null,
    iTune: this.props.location.state,
  };
  ...
  render() {
    ...
    return (
      <div>
        {/*SEO Support*/}
        <Helmet>
          <title>PP&City | iTune |</title>
          <meta name="description" content="PP&City." />
        </Helmet>
        {/*SEO Support End */}

        <Breadcrumb parent={"iTunes"} title={iTune.name} />
