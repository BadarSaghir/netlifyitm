...
import iTunesCollection from "./components/iTunes/iTune-collection";
...
import ITuneView from "./components/iTunes/iTune-view.jsx";
// Features
            ...
            <ScrollContext>
              <Switch>
                ...
                <Layout>
                  ...
                  />
                  {/* <Route
                    path={`${process.env.PUBLIC_URL}/books/books_collection`}
                  ...
                  />
                  <Route
                    path={`${process.env.PUBLIC_URL}/book/:id`}
                    component={BookView}
                  />
                  <Route
                    path={`${process.env.PUBLIC_URL}/music/:id`}
                    component={ITuneView}
                  />
                  <Route
                    path={`${process.env.PUBLIC_URL}/music`}
                    component={iTunesCollection}
                    exact="true"
                  />
                  <Route
                  ...
                  />
                  {/* <Route
                    path={`${process.env.PUBLIC_URL}/left-sidebar/books/:id`}
                    component={BookView}
                  /> */}
                  <Route
